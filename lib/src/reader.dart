...
import 'package:dart_rfid_library/src/reader_hf/ascii-proto/deskid_iso.dart';
import 'package:dart_rfid_library/src/reader_hf/ascii-proto/dwarf15.dart';
import 'package:dart_rfid_library/src/reader_hf/ascii-proto/quasar_mx.dart';
import 'package:dart_rfid_library/src/reader_hf/at-proto/deskid_nfc.dart';
import 'package:dart_rfid_library/src/reader_hf/at-proto/dwarf_nfc.dart';
import 'package:dart_rfid_library/src/reader_hf/at-proto/qr_nfc.dart';
...
import 'package:dart_rfid_library/src/reader_library_base.dart';
import 'package:dart_rfid_library/src/reader_uhf/ascii-proto/deskid_uhf.dart';
import 'package:dart_rfid_library/src/reader_uhf/ascii-proto/dwarf_g2.dart';
import 'package:dart_rfid_library/src/reader_uhf/ascii-proto/pulsar_mx.dart';
import 'package:dart_rfid_library/src/reader_uhf/at-proto/deskid_uhf_v2_e.dart';
import 'package:dart_rfid_library/src/reader_uhf/at-proto/deskid_uhf_v2_f.dart';
import 'package:dart_rfid_library/src/reader_uhf/at-proto/dwarf_g2_mini.dart';
import 'package:dart_rfid_library/src/reader_uhf/at-proto/dwarf_g2_v2.dart';
import 'package:dart_rfid_library/src/reader_uhf/at-proto/plrm.dart';
import 'package:dart_rfid_library/src/reader_uhf/at-proto/pulsar_fl.dart';
import 'package:dart_rfid_library/src/reader_uhf/at-proto/pulsar_lr.dart';
import 'package:dart_rfid_library/src/reader_uhf/at-proto/qrg2_etsi.dart';
import 'package:dart_rfid_library/src/reader_uhf/at-proto/qrg2_fcc.dart';
...
abstract class Reader {
  ...
  static Reader? getReaderImplementationByName({required String hardwareName, required CommInterface commInterface}) {
    ...
    final specificReader = switch (hardwareName) {
      ...
      "QRG2_FCC" => ReaderQRG2FCC(commInterface),
