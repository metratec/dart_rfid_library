...
class DwarfG2ReaderSettings extends UhfGen2ReaderSettings {
...
class ReaderDwarfG2 extends UhfReaderGen2 {
  ReaderDwarfG2(CommInterface commInterface)
      : super(
            commInterface,
            DwarfG2ReaderSettings(
